...
\item\contentsline{section}{src/\mbox{\hyperlink{state__machine__main_8py}{state\+\_\+machine\+\_\+main.\+py}} \\*The node state\+\_\+machine deals with the building of the state machine\textquotesingle{}s structure. ~\newline
...
\item\contentsline{section}{src/states/\mbox{\hyperlink{active_8py}{active.\+py}} \\*The class Active handles the active state. ~\newline
 A\+C\+T\+I\+VE has\+: ~\newline
...
\item\contentsline{section}{src/states/\mbox{\hyperlink{dummy__lfo_8py}{dummy\+\_\+lfo.\+py}} \\*Class Dummy\+L\+FO handles the look for object state. ~\newline
...
\item\contentsline{section}{src/states/\mbox{\hyperlink{dummy__mto_8py}{dummy\+\_\+mto.\+py}} \\*Class Dummy\+M\+TO handles the move towards object state. ~\newline
 M\+O\+VE T\+O\+W\+A\+R\+DS O\+B\+J\+E\+CT has\+: ~\newline
 -\/ outcome (arrived)\+: Mi\+Ro has arrived to the goal object }{\pageref{dummy__mto_8py}}{}
\item\contentsline{section}{src/states/\mbox{\hyperlink{failure_8py}{failure.\+py}} \\*The class Failure handles the failure state. ~\newline
 F\+A\+I\+L\+U\+RE has\+: ~\newline
 -\/ output (reset)\+: miro has expressed a sad behavior after a failure and gets back to idle state }{\pageref{failure_8py}}{}
\item\contentsline{section}{src/states/\mbox{\hyperlink{happy_8py}{happy.\+py}} \\*Class Happy handles the happy state. ~\newline
 H\+A\+P\+PY has\+: ~\newline
 -\/ outcome (ok)\+: Mi\+Ro signals that the goal has been reached }{\pageref{happy_8py}}{}
\item\contentsline{section}{src/states/\mbox{\hyperlink{idle_8py}{idle.\+py}} \\*The class Idle handles the idle state. ~\newline
 I\+D\+LE has\+: ~\newline
